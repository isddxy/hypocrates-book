...
export default function AddWantResultScreen({ route, navigation, navigation: { goBack } }) {

    const [ task, firstActionText ]   = route.params;
        ...
        style={styles.container}>
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View style={styles.inner}>
                    <Text style={styles.header}>Какой результат вы хотите?</Text>
                    <View style={styles.btnsView}>
                        <TextInput
                            placeholder="Введите точное определения своего результата"
